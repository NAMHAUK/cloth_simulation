...
class VertexBvhBoundsUpdater final {
public:
    VertexBvhBoundsUpdater() = default;
    VertexBvhBoundsUpdater(const VertexBvhBoundsUpdater&) = delete;
    VertexBvhBoundsUpdater& operator=(const VertexBvhBoundsUpdater&) = delete;
