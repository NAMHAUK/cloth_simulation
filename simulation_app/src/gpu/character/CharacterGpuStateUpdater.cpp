    ...
    QOpenGLFunctions_4_5_Core& gl) const
{
    ...
    write_current_position_buffer(character_frame_alpha, vertex_view, gl);
...
void CharacterGpuStateUpdater::write_current_position_buffer(float character_frame_alpha,
                                                             const CharacterVertexBufferView& vertex_view,
                                                             QOpenGLFunctions_4_5_Core& gl) const
{
    ...
    gl.glProgramUniform1f(position_program_, position_frame_alpha_location_, character_frame_alpha);
