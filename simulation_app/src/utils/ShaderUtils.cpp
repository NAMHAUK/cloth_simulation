...
bool parse_shader_include(const std::string& line, std::filesystem::path& include_path)
{
...
std::optional<std::string> load_shader_source(const std::filesystem::path& shader_path,
