...
bool CharacterCollisionSolver::can_solve(const ClothPositionBufferView& position_view,
                                         const CharacterTriangleGeometryResources& character_geometry) const
{
...
{
    assert(can_solve(position_view, character_geometry));
    ...
    gl.glProgramUniform1ui(program_, character_triangle_count_location_, character_geometry.triangle_count);
