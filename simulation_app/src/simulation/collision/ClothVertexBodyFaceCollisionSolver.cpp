...
{
    assert(can_solve(motion_view, collision_view, character_geometry, collision_pair_view));

    collision_pair_view.clear_correction_sums(gl);
    run_pair_accumulation_stage(motion_view, character_geometry, collision_pair_view, gl);
