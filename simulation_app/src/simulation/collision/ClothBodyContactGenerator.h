...
class ClothBodyContactGenerator final {
public:
    ClothBodyContactGenerator() = default;
    ClothBodyContactGenerator(const ClothBodyContactGenerator&) = delete;
    ClothBodyContactGenerator& operator=(const ClothBodyContactGenerator&) = delete;
    ...
    bool can_generate(const ClothMotionBufferView& motion_view,
    ...
    void generate_contacts(const ClothMotionBufferView& motion_view,
                           const ClothMeshTopologyResources& cloth_topology,
                           const DistanceConstraintBufferView& cloth_edges,
                           const CharacterVertexBufferView& character_vertex_view,
                           const TriangleGeometryResources& character_geometry,
...
private:
    struct ClothVertexBodyFaceStage final {
        GLuint program = 0;
    ...
    struct ClothEdgeBodyEdgeStage final {
        GLuint program = 0;
        GLint edge_count = -1;
        GLint max_pairs = -1;
        GLint thickness = -1;
    ...
    struct ClothFaceBodyVertexStage final {
        GLuint program = 0;
    ...
    struct DispatchBuildStage final {
        GLuint program = 0;
        GLint max_pairs = -1;
        GLint local_size = -1;
    };

    void generate_cloth_vertex_body_face_contacts(const ClothMotionBufferView& motion_view,
                                                  const TriangleGeometryResources& character_geometry,
                                                  const TriangleBvhResources& character_bvh,
                                                  const ContactPairBuffers& contact_pairs,
                                                  QOpenGLFunctions_4_5_Core& gl) const;
    void generate_cloth_edge_body_edge_contacts(const ClothMotionBufferView& motion_view,
                                                const DistanceConstraintBufferView& cloth_edges,
                                                const CharacterVertexBufferView& character_vertex_view,
                                                const EdgeBvhResources& body_edge_bvh,
                                                const ContactPairBuffers& contact_pairs,
                                                QOpenGLFunctions_4_5_Core& gl) const;
    void generate_cloth_face_body_vertex_contacts(const ClothMotionBufferView& motion_view,
                                                  const ClothMeshTopologyResources& cloth_topology,
                                                  const CharacterVertexBufferView& character_vertex_view,
                                                  const VertexBvhResources& body_vertex_bvh,
                                                  const ContactPairBuffers& contact_pairs,
                                                  QOpenGLFunctions_4_5_Core& gl) const;
    void build_dispatch_command(const ContactPairBuffers& contact_pairs, QOpenGLFunctions_4_5_Core& gl) const;
    bool has_programs() const;

    ClothVertexBodyFaceStage cloth_vertex_body_face_;
    ClothEdgeBodyEdgeStage cloth_edge_body_edge_;
    ClothFaceBodyVertexStage cloth_face_body_vertex_;
    DispatchBuildStage dispatch_build_;
