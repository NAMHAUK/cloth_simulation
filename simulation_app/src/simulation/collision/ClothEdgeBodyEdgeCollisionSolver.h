...
private:
    ...
    void run_pair_accumulation_stage(const ClothMotionBufferView& motion_view, const DistanceConstraintBufferView& cloth_edges, const CharacterVertexBufferView& character_vertex_view, const EdgeBvhResources& body_edge_bvh, const CollisionContactBufferView& collision_contact_view, QOpenGLFunctions_4_5_Core& gl) const;
