...
inline constexpr float prefit_surface_search_radius = 0.15f;
...
static_assert(cloth_collision_detection_margin >= 0.0f);
...
static_assert(prefit_surface_search_radius >= prefit_pushout_margin);
