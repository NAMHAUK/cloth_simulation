...
struct ShaderPaths
{
    ...
    std::filesystem::path body_bvh_bounds_update_compute;
    ...
    std::filesystem::path collision_dispatch_size_compute;
    std::filesystem::path cloth_cloth_vertex_face_detect_compute;
    std::filesystem::path cloth_cloth_vertex_face_accumulate_compute;
    std::filesystem::path cloth_cloth_initial_layer_accumulate_compute;
    std::filesystem::path cloth_body_triangle_id_build_compute;
    std::filesystem::path cloth_cloth_collision_apply_compute;
    std::filesystem::path cloth_vertex_body_face_detect_compute;
    std::filesystem::path cloth_vertex_body_face_accumulate_compute;
    std::filesystem::path body_vertex_cloth_face_detect_compute;
    std::filesystem::path body_vertex_cloth_face_accumulate_compute;
    std::filesystem::path cloth_edge_body_edge_detect_compute;
    std::filesystem::path cloth_edge_body_edge_accumulate_compute;
...
inline ShaderPaths make_shader_paths(const std::filesystem::path& project_root)
{
    ...
    return {
        ...
        shader_dir / "body" / "body_bvh_bounds_update.comp",
        ...
        shader_dir / "collision" / "collision_dispatch_size.comp",
        shader_dir / "collision" / "cloth_cloth_vertex_face_detect.comp",
        shader_dir / "collision" / "cloth_cloth_vertex_face_accumulate.comp",
        shader_dir / "collision" / "cloth_cloth_initial_layer_accumulate.comp",
        shader_dir / "cloth" / "setup" / "cloth_body_triangle_id_build.comp",
        shader_dir / "collision" / "cloth_cloth_collision_apply.comp",
        shader_dir / "collision" / "cloth_vertex_body_face_detect.comp",
        shader_dir / "collision" / "cloth_vertex_body_face_accumulate.comp",
        shader_dir / "collision" / "body_vertex_cloth_face_detect.comp",
        shader_dir / "collision" / "body_vertex_cloth_face_accumulate.comp",
        shader_dir / "collision" / "cloth_edge_body_edge_detect.comp",
        shader_dir / "collision" / "cloth_edge_body_edge_accumulate.comp",
